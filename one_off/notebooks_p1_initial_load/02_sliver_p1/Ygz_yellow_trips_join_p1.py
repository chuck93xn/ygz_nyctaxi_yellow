...
# 1st join for pick up borough and zone
df_join_1 = df_trips.join(
                ...
                "left"
                    ...
                    df_trips.processing_timestamp
                )

# COMMAND ----------

# 2nd join for drop off borough and zone
df_join_final = df_join_1.join(
                                ...
                                "left"
                                            ...
                                            df_join_1.processing_timestamp
                                )

# COMMAND ----------

df_join_final.write.mode("overwrite").saveAsTable("nyctaxi_ygz.`02_silver`.yellow_trips_enriched")